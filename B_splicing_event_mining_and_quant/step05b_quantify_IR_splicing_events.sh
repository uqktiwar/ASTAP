...
SPLC="/scratch/user/uqktiwar/NCCSPLICE/IR"

OP=$SPLC"/IR1"
mkdir $OP
python $BASE/find_ovlappin_introns_and_quant_ir.1.py -w $SPLC -i ret_introns_regions.1.out -o $OP -b $BAM -bams 24701 24703 24704 -s "Aligned.sortedByCoord.out" -l rf
python $BASE/find_skipping_jn_counts_for_IR.1.py -w $SPLC -i ret_introns_regions.1.out -o $OP -b $BAM -bams 24701 24703 24704 -s "Aligned.sortedByCoord.out" -l rf

python $BASE/quant_junctions_for_IR.1.py -w $SPLC -i soxPN.IR.junctions.1.bed -o $OP -b $BAM -bams 24701 24703 24704 -s "Aligned.sortedByCoord.out" -l rf
